                ...
                <div class="col-md-4 mb-5 px-4">
                    <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                        <form id="profile-form">
                            ...
                            <img src="<?php echo USERS_IMG_PATH.$u_fetch['profile'] ?>" class="img-fluid mb-3 rounded-circle">

                            <label class="form-label">New Picture</label>
                            <input name="profile" type="file" accept=".jpg, .jpeg, .png, .webp, .gif" class="mb-4 form-control shadow-none" required>
