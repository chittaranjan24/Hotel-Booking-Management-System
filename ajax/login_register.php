<?php
    ...
    require('../component/PHPMailer/Exception.php');
    require('../component/PHPMailer/PHPMailer.php');
    require('../component/PHPMailer/SMTP.php');
    ...
    function send_mail($uemail,$token,$type)
    {
        ...
        try {
            ...
            $mail->Username   = 'chittaranjanshit1234@gmail.com';                     //SMTP username
            $mail->Password   = 'twwf tagq sstk tetw';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('chittaranjanshit1234@gmail.com', 'CS WEBDEV');
