                        ...
                        echo <<< data
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-dark shadow-none dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                    ...
                                    $_SESSION[uName] <i class="bi bi-gear"></i>
                                </button>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 p-0 mb-3">
                                ...
                                <input name="profile" type="file" accept=".jpg, .jpeg, .png, .webp, .gif" class="form-control shadow-none" required>
                            </div>
            ...
            <form id="forgot-form">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center">
                        <i class="bi bi-shield-fill-check"></i>  Forgot Password
                    </h5>
                </div>
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                    ...
                    <div class="mb-2 text-end">
                        ...
                        <button class="btn btn-dark shadow-none" type="submit">SEND LINK</button>
                    </div>
                </div>
            </form>
        </div>
