...
<body class="bg-light">
    ...
    <!-- Start manage room images Modal -->
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <input type="file" name="image" accept=".jpg, .JPG, .png, .PNG, .jpeg, .JPEG, .webp, .WEBP, .gif, .GIF" class="form-control shadow-none mb-3" required>
